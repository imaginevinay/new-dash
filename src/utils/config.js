export const CHART_DATA_CONFIG = [
  ...
  },
  {
    ...
    previewImage: "/src/assets/images/histogram-preview.svg",
    types: [
      {
        id: "vertHistogram",
      ...
      {
        id: "vertStackedHistogram",
        name: "Vertical Stacked Histogram",
      ...
      {
        id: "horizStackedHistogram",
        name: "Horizontal Stacked Histogram",
        icon: "/src/assets/charts/chart-types/sHistogram.svg",
        previewImage: "/src/assets/charts/previews/sHistogram.svg",
        parent: "histogram",
        orientation: 'h',
